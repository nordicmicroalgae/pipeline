...
start.time <- Sys.time()
source("code/03_get_dyntaxa_links.R")
end.time <- Sys.time()
...
start.time <- Sys.time()
source("code/04_get_algaebase_links.R")
end.time <- Sys.time()
...
source("code/05_match_norcca_names.R")
end.time <- Sys.time()
...
source("code/06_get_hab_links.R")
```
...
start.time <- Sys.time()
source("code/07_get_itis_links.R")
end.time <- Sys.time()
...
start.time <- Sys.time()
source("code/08_get_ncbi_links.R")
end.time <- Sys.time()
...
start.time <- Sys.time()
source("code/09_get_gbif_links.R")
end.time <- Sys.time()
...
source("code/10_update_filters.R")
```
